...
## アプリケーション開発＞リーダブルパスワード（読み取り可能パスワード）
- 発生
    - xxx
- 回避
    - xxx
...
## アプリケーション開発＞シュードキー・ニートフリーク（疑似キー潔癖症）
- 発生
    - xxx
- 回避
    - xxx
...
## アプリケーション開発＞ディプロマティック・イミュニティ（外交特権）
- 発生
    - xxx
- 回避
    - xxx
